...
export default function InputComponent(): JSX.Element {
    ...
    function clearFilter(e: any) {
        incDisplay()
        console.log("event Clicked",display)
        setFilter(e.target.getAttribute("data-name"));
    }

    return (
        <div className='flex justify-around mb-4'>
            <input type="text" value={textInput} onChange={(e) => setTextInput(e.target.value)} placeholder='Search for a country...' className='border-[1px] p-3 pl-12 w-[400px] bg-wht   rounded-lg' />
